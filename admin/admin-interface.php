...
function propanel_siteoptions_add_admin() {
    ...
    $tt_page = add_menu_page('SaoBien Options', 'SaoBien Options', 'edit_theme_options', 'siteoptions','propanel_siteoptions_options_page',THEME_URL.'/admin/images/icon.png');
